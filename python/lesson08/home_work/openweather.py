...
print(f'Температура в городе {city} — {data["main"]["temp"]} øC')  # Вытаскиваем градусы из данных
...
if save_data == 'y' or 'Y':
    ...
    if os.path.isfile("{}.db".format(city)):  # Если БД уже есть - обновляем
        ...
        data["sys"]["id"], city, data["dt"], data["main"]["temp"], data["main"]["temp"]))  # Обновляем значения в БД
