...
def get_search_page(request, page):
    ...
    print(f'Запрашиваю данные для позиции {request}')
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        print('Передайте аргументом список вакансий, которые нужно обновить разделяя запятыми:')
    else:
        request_list = ''
        ...
        for request in request_list:
            ...
            collection_name = slugify(request, to_lower=True, separator='_')
